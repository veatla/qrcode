...
export const testKanji = function testKanji(str: string) {
    return TEST_KANJI.test(str);
};

export const testNumeric = function testNumeric(str: string) {
    return TEST_NUMERIC.test(str);
};

export const testAlphanumeric = function testAlphanumeric(str: string) {
