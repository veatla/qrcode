...
<script>
    QRCode.toCanvas(document.getElementById("canvas"), "sample text", { toSJISFunc: QRCode.toSJIS }, function (error) {
        if (error) console.error(error);
        console.log("success!");
    });
</script>
...
This lib is based on "QRCode for JavaScript" which Kazuhiko Arase and "node-qrcode" made by Ryan Day thankfully MIT licensed.
