...
const NumericData = require("core/numeric-data").default;
const AlphanumericData = require("core/alphanumeric-data").default;
const ByteData = require("core/byte-data").default;
...
test("Segments from array", function (t) {
  ...
  t.strictSame(Segments.fromArray([{}]), [], "Should return an empty array");
...
test("Segments raw split", function (t) {
  ...
  t.strictSame(Segments.rawSplit("abcDEF123"), splitted);
